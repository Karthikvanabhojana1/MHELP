 ...
 * @author karthikv
 */
public class ListPanelForm extends javax.swing.JPanel {
    ...
    /**
    /**
     * Creates new form ListPanelForm
     */
    public ListPanelForm(JPanel jpanelWorkArea, Business business, Properties properties, PatientProfile patient) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(row<0) {
            JOptionPane.showMessageDialog(this, "Please select a row to View Report Details.", "Error", JOptionPane.ERROR_MESSAGE);
        ...
        DisplayReport listofPatientReports=new DisplayReport(jpanelWorkArea,business,properties,patient,patientReport,appointmentId);
